...
interface PizzaNewCategoryModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function PizzaNewCategoryModal({
  isOpen,
  onClose,
  onAddCategory,
  predefinedCategories,
}: PizzaNewCategoryModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px] p-0 overflow-hidden" data-lov-id="app/cadastro-produto/cadastro-pizza/PizzaNewCategoryModal.tsx">
        ...
        <form className="px-6 pt-4 pb-2 flex flex-col gap-4" onSubmit={e => { e.preventDefault(); handleContinue(); }}>
          <div>
