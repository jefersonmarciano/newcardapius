...
const PizzaCategorySection: React.FC<PizzaCategorySectionProps> = ({ selectedCategories, setIsCategoryModalOpen, toggleCategory }) => {
  return (
...
export default PizzaCategorySection; 